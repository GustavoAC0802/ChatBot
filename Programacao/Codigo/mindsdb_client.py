...
Identifique:
- intent: "search_movie" (buscar filme pelo nome), "search_actor" (buscar filmes de um ator/diretor), ou "popular" (filmes populares)
- movie_name: nome do filme se mencionado (ou null)
- actor_name: nome do ator/diretor se mencionado (ou null)

Retorne apenas: {{"intent": "...", "movie_name": "...", "actor_name": "..."}}'
                """
